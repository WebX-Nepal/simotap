...
function AboutUsSection() {
  return (
    <>
      <div className="container bg-black m-auto w-[95%]">
        <img className='opacity-50 md:h-[356px] md:w-[100%] m-auto object-cover ' src="image/aboutus.png" alt="" />
      </div>

      <div className="relative bottom-[11em] h-60 w-60 bg-[#308] m-auto rounded-full flex items-center justify-center">
        <img className='h-5' src="image/simatap.png" alt="" />
      </div>
      <div className={styles.aboutUsSection}>
        <div className={styles.about}>

          <h1 className='m-auto'>Simotap Business pvt. ltd</h1>
